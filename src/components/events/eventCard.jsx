...
export const EventCard = () => {
  return (
    <div className='flex flex-col mx-4 md:mx-auto h-[232px] md:w-auto lg:w-[35vw] lg:h-[246px]'>
      <div className='relative rounded-[10px] shadow-card'>
        <Image
          ...
          height={233}
          alt='Event Image'
          className='flex lg:hidden w-full rounded-[10px] h-[232px]'
        />
        <Image
      ...
      <div className='flex flex-col px-4 w-[330px] lg:w-[20vw] items-start pt-8 absolute'>
