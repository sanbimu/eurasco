  ...
  return (
    <div className='flex flex-col h-full min-h-[279px] md:items-center md:min-h-[18vh] lg:h-[30vh] mt-20 md:mt-0'>
      <Image
        ...
        height={281}
        alt='Contact Image'
        className='flex md:hidden w-full absolute'
      />

      <div className='flex flex-col px-[25px] items-center  z-50'>
        ...
        <p className='pt-6  font-open text-[15px] leading-[25px] text-black text-center'>
