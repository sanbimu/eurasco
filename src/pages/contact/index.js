...
export default function Contact() {
  return (
    <main>
      <div className="flex flex-col lg:flex-row h-screen items-center lg:justify-between w-screen mx-auto">
        <Image
        ...
        />
        <div className="hidden md:flex md:mt-32 lg:mt-48 lg:ml-[23%] items-center lg:h-[70vh] lg:w-[70vw]">
          <ContactCard />
        </div>
