    ...
    <>
      ...
      <div className='min-h-[75vh] flex flex-col relative w-screen justify-center'>
        ...
        <div className='flex flex-col items-start justify-end min-h-[75vh] p-[25px] gap-4 z-20'>
          ...
          <div className='font-mont font-semibold text-xl leading-6  text-lightGrey '>
            {`${formatDateEvents(
      ...
      {/* CONTENT */}
      <div className='flex flex-col font-open leading-6 md:mx-[25vw] md:px-0 lg:w-[50%] text-black pb-6'>
