      ...
      <div className='flex flex-col w-full'>
        ...
        <div className='flex flex-col lg:flex-row md:gap-0 md:px-10 lg:mx-auto gap-4 overflow-auto lg:pb-20 lg:gap-6 lg:pt-2  '>
          ...
          <div className='flex md:hidden lg:flex pb-20 lg:pb-10'>
            <Link
              className='mx-4 uppercase text-center text-white font-open font-semibold text-[20px] md:text-sm tracking-[1px] bg-lightGreen rounded-[10px] py-4 md:py-2 w-full md:w-[200px] lg:w-[170px]'
              href={"/events"}
            >
              discover our event
            </Link>
