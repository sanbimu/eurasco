  ...
  return (
    <>
      <div className="flex h-screen w-full">
        ...
        />
        <div className="flex flex-col absolute z-[99] self-center font-open px-[13px] md:pl-12 lg:pl-36 lg:pr-72 text-white">
          ...
          <button
            className="uppercase border-2 z-[99] border-lightGreen  rounded-[3px] px-8 py-2 self-start font-semibold tracking-[2px] text-[15px]"
